...
namespace YASM.Utils
{
    ...
    /// 
    /// </summary>
    /// <see cref="https://github.com/StephenCleary/AsyncEx/blob/master/Source/Nito.AsyncEx%20(NET45%2C%20Win8%2C%20WP8%2C%20WPA81)/NotifyTaskCompletion.cs"></see>
    ...
    public static class NotifyTaskCompletion
    {
        ...
        private sealed class NotifyTaskCompletionImplementation : INotifyTaskCompletion
        {
            ...
            public NotifyTaskCompletionImplementation(Task task)
            {
                ...
                if (task.IsCompleted)
                {
                    TaskCompleted = System.Threading.Tasks.Task.FromResult<object>(null);
                    return;
                }
